...
**New to RE-cue?** → **[Getting Started Guide](./GETTING-STARTED.md)**  
Set up RE-cue and run your first analysis in 30 minutes.

**Need comprehensive reference?** → **[Complete User Guide](./USER-GUIDE.md)**  
In-depth documentation of all features, commands, and configuration options.

**Want advanced techniques?** → **[Advanced Usage Guide](./ADVANCED-USAGE.md)**  
Power-user workflows, customization, performance tuning, and integrations.

## 📚 Available Guides

| Guide | Audience | Focus | Time |
|-------|----------|-------|------|
...
## 📋 What RE-cue Generates

RE-cue analyzes your code and generates comprehensive documentation:
...
| **API Contracts** | OpenAPI 3.0 specifications | API consumers, developers |

## 🔗 Related Documentation

- **[Framework Guides](../frameworks/README.md)** - Framework-specific documentation and examples
- **[Developer Guides](../developer-guides/)** - Contributing, extending, and customizing RE-cue
- **[API Reference](../api/)** - Complete API documentation
- **[Architecture](../architecture/)** - System design and technical architecture

## ❓ Need Help?

1. **Search these guides** - Use Ctrl/Cmd + F to find specific topics
2. **Check [Troubleshooting](./TROUBLESHOOTING.md)** - Common issues and solutions  
3. **Browse [GitHub Issues](https://github.com/cue-3/re-cue/issues)** - Known issues and featureuests
4. **Ask questions** - [Create a new issue](https://github.com/cue-3/re-cue/issues/new) or [discussion](https://github.com/cue-3/re-cue/discussions)
