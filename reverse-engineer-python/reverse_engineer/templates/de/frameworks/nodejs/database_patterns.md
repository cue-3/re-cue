## Datenbankzugriffsmuster - Node.js
...
1. **Verbindungspooling verwenden** - Angemessene Pool-Größen konfigurieren
2. **Häufig abgefragte Felder indizieren** - Abfrageleistung verbessern
3. **Eager vs. Lazy Loading** - Nur laden, was benötigt wird
4. **Transaktionen für Konsistenz** - Für zusammenhängende Operationen verwenden
5. **Eingaben validieren** - Schema-Validierung verwenden
6. **Prepared Statements verwenden** - SQL-Injection verhindern
7. **Abfragen überwachen** - Langsame Abfragen zur Optimierung protokollieren
8. **Paginierung** - Große Datensätze immer paginieren
9. **Soft Deletes** - Soft-Delete-Muster für wichtige Daten erwägen
10. **Migrationen** - Migrationswerkzeuge für Schema-Änderungen verwenden