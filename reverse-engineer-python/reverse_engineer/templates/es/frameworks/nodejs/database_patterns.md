## Patrones de Acceso a Base de Datos - Node.js
...
1. **Usar agrupación de conexiones** - Configurar tamaños de pool apropiados
2. **Indexar campos consultados frecuentemente** - Mejorar el rendimiento de las consultas
3. **Carga ansiosa vs perezosa** - Cargar solo lo que necesitas
4. **Transacciones para consistencia** - Usar para operaciones relacionadas
5. **Validar entrada** - Usar validación de esquema
6. **Usar declaraciones preparadas** - Prevenir inyección SQL
7. **Monitorear consultas** - Registrar consultas lentas para optimización
8. **Paginación** - Siempre paginar conjuntos de datos grandes
9. **Eliminación suave** - Considerar patrón de eliminación suave para datos importantes
10. **Migraciones** - Usar herramientas de migración para cambios de esquema