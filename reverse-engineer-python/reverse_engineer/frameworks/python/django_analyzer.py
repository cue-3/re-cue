...
class DjangoAnalyzer(BaseAnalyzer):
    ...
    def _analyze_urls_file(self, file_path: Path):
        ...
        app_name = file_path.parent.name if file_path.parent.name != self.project_name else 'main'
    ...
    def discover_services(self) -> List[Service]:
        ...
        for service_file in service_files:
            ...
            try:
                ...
                # Find view classes
                view_classes = re.findall(
                    r'class\s+(\w+(?:View|ViewSet|Serializer))\s*\(',
                    content
                )
