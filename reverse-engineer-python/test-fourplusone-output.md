...
This document presents the architecture of the cue-3 system using the 4+1 architectural view model proposed by Philippe Kruchten. The model uses five concurrent views to describe the system from different perspectives:
...
The system contains 20 core domain models organized by functional areas.
...
The application is organized into 7 major subsystems.

| Subsystem | Purpose | Components |
|-----------|---------|------------|
| **Primary Subsystem** | Core business logic | 10 components including ForecastService, StoryService, SprintService |
| **Primary Subsystem** | Core business logic | 10 components including ForecastService, StoryService, SprintService |

#### Service Layer

**10 Backend Services** orchestrate business logic:
...
**Transaction Boundaries**: 28 identified
- Write operations: 28
...
```
src.main
├── controllers/                 # REST controllers (50 items)
│   ├── Connection pool: 20
│   ├── Timeout: 30s
│   └── Max connections: 100
│
...
The system has **5 identified actors**:

| Actor | Type | Access Level | Description |
|-------|------|--------------|-------------|
| **Public** | Internal User | Standard | Primary system user |
| **User** | Internal User | Standard | Primary system user |
| **Notification Service** | Internal User | Standard | Primary system user |
...
The cue-3 system demonstrates modularity, scalability, and maintainability using modern frameworks and best practices. The 4+1 view model provides comprehensive documentation of the system from multiple perspectives:

- **Logical View**: 20 models, 10 services
- **Process View**: 50 endpoints with standard workflows
- **Development View**: Organized module structure with 7 boundaries
- **Physical View**: Container-based deployment with standard infrastructure
- **Use Case View**: 45 use cases across 5 actors
